...
// y NO intercepta taps: TODO el aviso es pointer-events-none (es solo informativo, sin
// nada tocable) — si no, al ir en z-[250] por encima de modales/contenido, su huella se
// comería taps sobre el header de un modal o el primer control de la página estando
// offline (auditoría 2026-09-17). Respeta el notch (safe-area,
...
export function OfflineBanner() {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 rounded-full border border-amber-400/40 bg-neutral-900/95 px-4 py-2 shadow-2xl backdrop-blur">
