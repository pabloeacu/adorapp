...
export const Repertorio = () => {
  ...
  // Generación del PDF de la canción extraída a src/lib/songPdf.js (función pura
  // (song, key, ctx)); acá queda el wrapper fino que arma el ctx con la tabla de
  // categorías local. jsPDF sigue cargándose on-demand dentro de generateSongPdf.
  const generateSongPDF = (song, key) => generateSongPdf(song, key, { categoryConfig });
