...
- `leader-activity-digest` `0 1 * * *` (22:00 ART): resumen diario a los pastores (SOLO correo) de las altas/ediciones/eliminaciones que hicieron LÍDERES o miembros EDITORES sobre songs/orders/bands en las últimas 24 h; solo si hubo movimientos. Detalla los nombres de las canciones por acción y autor. Ver "Estado al 2026-09-06".
